export default function Slide5Buvljak() {
  return (
    <div className="w-screen h-screen overflow-hidden relative" style={{ background: "#1a1612" }}>
      ...
      {/* Slide number */}
      <div className="absolute" style={{ top: "4vh", right: "5vw", fontFamily: "Nunito, sans-serif", fontWeight: 800, fontSize: "2.2vw", color: "#d97706", opacity: 0.4 }}>05</div>

      {/* Left: title */}
      <div className="absolute" style={{ top: "50%", left: "6vw", transform: "translateY(-50%)", width: "38vw" }}>
        <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 900, fontSize: "7vw", color: "#ffffff", letterSpacing: "-0.03em", lineHeight: 1.0 }}>
        ...
        <div style={{ marginTop: "2.5vh", fontFamily: "Nunito, sans-serif", fontWeight: 700, fontSize: "3vw", color: "rgba(255,255,255,0.65)", lineHeight: 1.35, textWrap: "pretty" }}>
      ...
      <div className="absolute" style={{ top: "50%", right: "5vw", transform: "translateY(-50%)", width: "44vw", display: "flex", flexDirection: "column", gap: "2.5vh" }}>
        <div style={{ background: "rgba(255,255,255,0.06)", borderRadius: "1vw", padding: "3vh 2.8vw", border: "0.12vw solid rgba(255,255,255,0.1)" }}>
          <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 800, fontSize: "2.6vw", color: "#d97706", marginBottom: "0.8vh" }}>Sto se razmjenjuje</div>
          <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 700, fontSize: "3vw", color: "rgba(255,255,255,0.85)", lineHeight: 1.3 }}>Udzbenici, pribor, oprema — zamjena, posudba ili dar</div>
        </div>
        <div style={{ background: "rgba(255,255,255,0.06)", borderRadius: "1vw", padding: "3vh 2.8vw", border: "0.12vw solid rgba(255,255,255,0.1)" }}>
          <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 800, fontSize: "2.6vw", color: "#d97706", marginBottom: "0.8vh" }}>Kako funkcionira</div>
          <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 700, fontSize: "3vw", color: "rgba(255,255,255,0.85)", lineHeight: 1.3 }}>Rezervacija preuzimanja putem kalendara</div>
        </div>
        <div style={{ background: "rgba(217,119,6,0.15)", borderRadius: "1vw", padding: "2.5vh 2.8vw", border: "0.12vw solid rgba(217,119,6,0.3)" }}>
          <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 700, fontSize: "3vw", color: "rgba(255,255,255,0.85)", lineHeight: 1.3 }}>Smanjuje troskove i potice solidarnost u razredu</div>
        </div>
      </div>
    </div>
  );
