export default function Slide8Sigurnost() {
  return (
    <div className="w-screen h-screen overflow-hidden relative" style={{ background: "#f7f3ee" }}>
      ...
      {/* Slide number */}
      <div className="absolute" style={{ top: "4vh", right: "5vw", fontFamily: "Nunito, sans-serif", fontWeight: 800, fontSize: "2.2vw", color: "#1a8a72", opacity: 0.4 }}>08</div>

      {/* Main layout: left title + right content */}
      <div className="absolute" style={{ top: "50%", left: "6vw", transform: "translateY(-50%)", width: "36vw" }}>
        <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 900, fontSize: "6vw", color: "#1a1612", letterSpacing: "-0.03em", lineHeight: 1.0, textWrap: "balance" }}>
          Sigurnost i pristup
        </div>
        ...
        <div style={{ marginTop: "3vh", background: "#1a8a72", borderRadius: "1vw", padding: "2.5vh 2.5vw", display: "inline-block" }}>
          <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 900, fontSize: "3.5vw", color: "#fff", letterSpacing: "0.05em" }}>UCE-7-01</div>
          <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 700, fontSize: "2.2vw", color: "rgba(255,255,255,0.75)", marginTop: "0.5vh" }}>Primjer pristupnog koda</div>
        </div>
      </div>
      ...
      <div className="absolute" style={{ top: "50%", right: "5vw", transform: "translateY(-50%)", width: "46vw", display: "flex", flexDirection: "column", gap: "2.2vh" }}>
        <div style={{ background: "#ffffff", borderRadius: "1vw", padding: "2.8vh 2.5vw", boxShadow: "0 2px 16px rgba(26,22,18,0.07)", display: "flex", gap: "2.5vw", alignItems: "center" }}>
          ...
          <div>
            <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 800, fontSize: "3.2vw", color: "#1a8a72", lineHeight: 1 }}>Ucenik</div>
            <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 700, fontSize: "2.8vw", color: "#6b5c4e", marginTop: "0.6vh" }}>Pristup svim modulima, zaradzuje bodove</div>
          </div>
        </div>
        <div style={{ background: "#ffffff", borderRadius: "1vw", padding: "2.8vh 2.5vw", boxShadow: "0 2px 16px rgba(26,22,18,0.07)", display: "flex", gap: "2.5vw", alignItems: "center" }}>
          <div style={{ width: "0.5vw", height: "6vh", background: "#2563eb", borderRadius: "2px", flexShrink: 0 }} />
          <div>
            <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 800, fontSize: "3.2vw", color: "#2563eb", lineHeight: 1 }}>Ucitelj</div>
            <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 700, fontSize: "2.8vw", color: "#6b5c4e", marginTop: "0.6vh" }}>Nudi Expertnu pomoc, upravlja materijalima</div>
          </div>
        </div>
        <div style={{ background: "#ffffff", borderRadius: "1vw", padding: "2.8vh 2.5vw", boxShadow: "0 2px 16px rgba(26,22,18,0.07)", display: "flex", gap: "2.5vw", alignItems: "center" }}>
          <div style={{ width: "0.5vw", height: "6vh", background: "#7c3aed", borderRadius: "2px", flexShrink: 0 }} />
          <div>
            <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 800, fontSize: "3.2vw", color: "#7c3aed", lineHeight: 1 }}>Admin</div>
            <div style={{ fontFamily: "Nunito, sans-serif", fontWeight: 700, fontSize: "2.8vw", color: "#6b5c4e", marginTop: "0.6vh" }}>Generira kodove, upravlja korisnicima</div>
          </div>
        </div>
      </div>
    </div>
